...
/**
 * Lab_7 Collections. Created by AdminY on 28.11.2015.
 */
public class VectorCollectionTest {

    private ArrayVector testVector;
    private VectorCollection instance;
    private Vector[] someVector1;
    ...
    public void testContainsAll() throws Exception {
        Collection temp = new VectorCollection(someVector1);
        boolean result = instance.containsAll(temp);
        boolean expValue = true;
        assertEquals(expValue, result);
    }
